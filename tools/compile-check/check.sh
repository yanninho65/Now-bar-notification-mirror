...
APP=$(find "$REPO/app/src/main/java" -name '*.kt' | grep -v -E 'MainActivity|AppSelectionActivity|AppSelectionAdapter|MatchesAdapter|SofascoreHomeAdapter|SimpleListAdapter')
